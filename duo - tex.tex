...
-\frac{\partial W_{A}}{\partial t} & =\frac{1}{2}\sigma^{2}S^{2}\frac{\partial^{2}W_{A}}{\partial S^{2}}+\rho S\frac{\partial W_{A}}{\partial S}-\rho W_{A}, ~~t\in[0,T),~S\in (H_d(t),H_u(t))\\\label{eqn:ter}
...
\begin{align*}
W_{A}(t,S) & =E_{t}\Bigg[e^{-\rho(\zeta-t)}rT\cdot\mathbf{1}_{\{\zeta\le\tau,\eta\}}+e^{-\rho(\tau-t)}r\tau\cdot\mathbf{1}_{\{\tau<\eta,\zeta\}}+e^{-\rho(\eta-t)}r\eta\cdot\mathbf{1}_{\{\eta<\tau,\zeta\}}\Bigg],
\end{align*}
...
\begin{align*}
-\frac{\partial W_{A1}}{\partial t} & =\frac{1}{2}\sigma^{2}S^{2}\frac{\partial^{2}W_{A1}}{\partial S^{2}}+\rho S\frac{\partial W_{A1}}{\partial S}-\rho W_{A1},~~t\in[0,T),~S\in (H_d(t),H_u(t))\\
W_{A1}(T,S) & =rT\\
W_{A1}(t,H_{u}(t)) & =rt\\
W_{A1}(t,H_d(t)) & =rt.
\end{align*}
...
Under the risk-neutral pricing framework, the current market value of Class A$^\prime$ token is given recursively as
\begin{align}
\begin{split}W_{A^\prime}(t,u,S,w) & =E_{t}\Bigg[e^{-\rho(\zeta^\prime-t)}[rT+g(\hat{W}_{\zeta^\prime-})+(1-g(\hat{W}_{\zeta^\prime-}))W_{A^\prime}(0,u+\zeta^\prime-t,S_{\zeta^\prime},1)]\cdot\mathbf{1}_{\{\zeta^\prime\le\tau^\prime,\eta^\prime,\zeta,\eta\}}\\
 & \quad+e^{-\rho(\tau^\prime-t)}(r\tau^\prime+W_{A^\prime}(0,u+\tau^\prime-t,1,\hat{W}_{\tau^\prime}))\cdot\mathbf{1}_{\{\tau^\prime<\eta^\prime,\zeta^\prime,\zeta,\eta\}}\\
 & \quad+e^{-\rho(\eta^\prime-t)}(r\eta^\prime+1-V_{B}^{\eta^\prime-}+V_{B}^{\eta^\prime-}W_{A^\prime}(0,u+\eta^\prime-t,S_{\zeta^\prime},1))\cdot\mathbf{1}_{\{\eta^\prime<\tau^\prime,\zeta^\prime,\zeta,\eta\}}\\
 & \quad+e^{-\rho(\tau\land\eta)}(g(S_{\eta\land\zeta-})+(1-g(S_{\eta\land\zeta-}))W_{A^\prime}(\eta\land\zeta,0,1,W_A(0,1)))\cdot\mathbf{1}_{\{\zeta\land\eta<\tau^\prime,\eta^\prime,\zeta^\prime\}}\Bigg].
\end{split}
\label{VAL3}
\end{align}
Here $\zeta$ and $\eta$ are the first periodic and downward reset of Class A token after $t$, and $\zeta^\prime$, $\tau^\prime$ and $\eta^\prime$ are the first periodic, upward and downward reset of Class A$^\prime$ token after $t$, respectively. 
$$\hat{W}_t=W_A(h(t),S_t),$$
where $h(t)$ is time from Class A token's last reset as of $t$.
