...
The return volatility of our Class \Ap and A0 coins is very small. Indeed, Table \ref{tbl:volcomp} compares it with the volatility of ETH, S\&P 500 index, Gold price and U.S. Dollar index. 
...
\begin{table}[htb]
	...
	\toprule
	Index & ETH & Gold & S\&P 500 & US\$ Index & \Ap Coin & A0 Coin\\\midrule
	Volatility & 1.2049 & & 0.1315 & &  0.0087& 0.0254\\
	\bottomrule
	\end{tabular}
\end{table}
...
\begin{align*}
dP_{t}=r Pdt+\sigma P_{t}d\mathcal{B}_{t},
\end{align*}
...
\begin{proof}[Proof of Proposition \ref{prop:nonrecur}]
	...
	&\quad+\sum_{\tau_i>\tau_1\land\eta_1}e^{-r(\tau_i-\tau_1\land\eta_1)}\frac{Y_{\tau_i-}}{Y_{\tau_1\land\eta_1}}Rv_{\tau_i-}+\sum_{\eta_i>\tau_1\land\eta_1}e^{-r(\eta_i-\tau_1\land\eta_1)}\frac{Y_{\eta_i-}}{Y_{\tau_1\land\eta_1}}(Rv_{\eta_i-}+1-\mathcal{H}_d)\Bigg)\Bigg],
	\end{split}
	\end{align*}
	...
	\end{split}
	\end{align}
	where $\theta_N$ denotes the $N$-th interest payment time. Thanks to Lemma 2.1 in \cite{Dai:2016vj} and the boundedness of $W_A$, we have
	\begin{align*}
...
\begin{proof}[Proof of Theorem \ref{thm:main}]
	...
	\end{split}
	\end{align*}
	where $E^{(u,s,y)}_t$ is the $\mathbb{Q}$-expectation computed under the initial condition $v_{t-}=u$, $S_{t-}=s$, and $Y_{t-}=y$. So it remains to show that $W_A$ given as \eqref{VALnonrecur} is the unique classical solution to \eqref{eqn:PDEstart} -- \eqref{eqn:PDEend}. We prove this result based on the stochastic representation result for nonlocal PDE, i.e. Corollary 3.1 in \cite{Dai:2016vj}, and in the following we first establish a connection between this theorem and \eqref{prop:nonrecur}.
	...
	\end{align*}
	Then, Corollary 3.1 in \cite{Dai:2016vj} shows that $W$ is the unique classic solution to 
	\begin{align*}
...
\begin{proof}[Proof of Theorem \ref{thm:convergence}]
	We follow the notation in the proof of \ref{thm:main}. Lemma A.1 in \cite{Dai:2016vj} shows that the solution $W_A^{(k)}$ defined in Algorithm 1 can be stochastically represented as 
	\begin{align*}
	\begin{split}
...
\section{Valuation of Class A0 and A1 Coins}
...
\bibitem[13]{Leverage}Leverage. \textit{\href{https://www.investopedia.com/terms/l/leverage.asp}{https://www.investopedia.com/terms/l/leverage.asp}}

\bibitem[14]{Nakamoto}Nakamoto, S. 2008. Bitcoin: A peer-to-peer electronic cash system. \textit{\href{https://bitcoin.org/bitcoin.pdf}https://bitcoin.org/bitcoin.pdf}

\bibitem[15]{Rogoff}Rogoff, K. 2015. Costs and benefits to phasing out paper currency. \textit{NBER Macroeconomics Annual}, 29(1):445-456.

\bibitem[16]{USDT}Tether: Fiat currencies on the Bitcoin blockchain. \textit{\href{https://tether.to/wp-content/uploads/2016/06/TetherWhitePaper.pdf}{https://tether.to/wp-content/uploads/2016/06/TetherWhitePaper.pdf}}

\bibitem[17]{MAKERDAO}The Dai Stablecoin System. \textit{\href{https://makerdao.com/whitepaper/DaiDec17WP.pdf}{https://makerdao.com/whitepaper/DaiDec17WP.pdf}}

\bibitem[18]{ETH}White Paper: A Next-Generation Smart Contract and Decentralized Application Platform. \textit{\href{https://github.com/ethereum/wiki/wiki/White-Paper}{https://github.com/ethereum/wiki/wiki/White-Paper}}
