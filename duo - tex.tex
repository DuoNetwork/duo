...
\begin{itemize}
	...
	\item On downward reset $\eta$, Class A$^\prime$ and Class \Bp receive $r^\prime t + g(S_{\eta-})$ and $2rt-r^\prime t+ g(S_{\eta-})$, respectively, in the forms of underlying token, and each one Class A$^\prime$ and B$^\prime$ becomes $1-g(S_{\eta-})$ share.
\end{itemize}
...
\begin{align}
\begin{split}W_{A^\prime}(t,S) & =E_{t}\Bigg[e^{-\rho(\zeta-t)}[r^\prime T+g(S_{\zeta-})+(1-g(S_{\zeta-}))W_{A^\prime}(0,1)]\cdot\mathbf{1}_{\{\zeta\le\tau,\eta\}}\\
 & \quad+e^{-\rho(\tau-t)}(r^\prime\tau+W_{A^\prime}(0,1))\cdot\mathbf{1}_{\{\tau<\eta,\zeta\}}\\
 & \quad+e^{-\rho(\eta-t)}(r^\prime\eta+1-V_{B}^{\eta-}+V_{B}^{\eta-}W_{A^\prime}(0,1))\cdot\mathbf{1}_{\{\eta<\tau,\zeta\}}\Bigg],
\end{split}
\end{align}
...
\begin{align*}
-\frac{\partial W_{A^\prime}}{\partial t} & =\frac{1}{2}\sigma^{2}S^{2}\frac{\partial^{2}W_{A^\prime}}{\partial S^{2}}+\rho S\frac{\partial W_{A^\prime}}{\partial S}-\rho W_{A^\prime}, ~~t\in[0,T),~S\in (H_d(t),H_u(t))\\
